 ...
 *
 * Modified by Ludovic Dubost, XWiki SAS
 */

'use strict';

// Ludovic Dubost replaced default URL to be empty
var kDefaultURL = '';
// Ludovic Dubost modification end
...
//#endif
  ...
  fullscreen: function pdfViewFullscreen() {
    ...
    // Ludovic Dubost added force loading in top window
    if (parent!=window) {
      // load frame in top window
